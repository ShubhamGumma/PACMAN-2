...
function draw() {
  ...
  collum1();
  collum2();
  //if(ghost1.isTouching(border1)||ghost1.isTouching(d3)){
    //ghost1.velocityY = Math.round(random(1,3));
  //}

  //if(ghost1.isTouching(border2)){
    //ghost1.velocityX = Math.round(random(1,3));
    //ghost1.velocityY = 0;
  //}
  drawSprites();
}
...
function movementLeft(){
  if(frameCount%50===0){
    ghost2.velocityX = Math.round(random(-1,-3));
  }
}

function movementDown(){
  if(frameCount%50===0){
    ghost3.velocityY = Math.round(random(1,-3));
  }
}
